...
- `test/mailorderops/governor_test.cljk` -- unit tests of governor hard
  checks, scope exclusion, and the self-trip regression test
- `test/mailorderops/advisor_test.cljk` -- advisor proposal shape and
  consistency
- `test/mailorderops/phase_test.cljk` -- rollout phase logic
- `test/mailorderops/governor_contract_test.cljk` -- full graph
  integration, audit trail
- `test/mailorderops/store_contract_test.cljk` -- Store protocol and
